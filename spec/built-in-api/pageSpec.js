...
describe('Built-In "page" API', function () {

	it('responds with status code 200 for existing pages', function (done) {

		request('http://localhost:10080/api/page/root', function (error, response, body) {
	...
	it('responds with status code 404 and error detail for pages that don\'t exist', function (done) {
		...
		request('http://localhost:10080/api/page/fail', function (error, response, body) {
	...
	it('returns a page to contain default meta fields (child-one)', function (done) {
		...
		request('http://localhost:10080/api/page/root/child-one', function (error, response, body) {
			var page = JSON.parse(body);
